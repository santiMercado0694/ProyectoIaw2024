    ...
    <MaxWidthWrapper>
      {loading ? (
        ...
        <div className="container mx-auto py-8">
          {/* Título principal */}
          <Typography variant="h2" className="text-3xl font-bold text-center mb-4">Contáctanos</Typography>
            ...
            {!formSubmitted ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <Typography variant="h3" className="text-2xl font-bold mb-4">Envíanos un mensaje</Typography>
                ...
                <div className="contact-info-container md:col-start-2">
                  <Typography variant="h3" className="text-2xl font-bold mb-4">Información de Contacto</Typography>
